...
export const placeholderLitters: Litter[] = [
  ...
  },
  {
    ...
    readyOn: "2025-06-21",
    status: "weaning",
    notes: "Five puppies, all chocolate, two of them very dark.",
  },
  {
    id: "litter-c-2025",
    code: "C-2025",
...
export const placeholderPuppies: Puppy[] = [
  {
    ...
    heroAlt: "A chocolate Labrador puppy in a green collar sitting on cut grass.",
    gallery: [],
    notes: null,
    litterId: "A-2025",
    sireName: "Birch",
  ...
  },
  {
    ...
    status: "available",
    heroImage: images["dog-sire"].src,
    heroAlt: "A chocolate Labrador puppy in a blue collar standing on cut grass.",
    gallery: [],
    notes: null,
    litterId: "A-2025",
    sireName: "Birch",
  ...
  },
  {
    ...
    heroAlt: "A chocolate Labrador puppy in a red collar lying in cut grass.",
    gallery: [],
    notes: null,
    litterId: "A-2025",
    sireName: "Birch",
  ...
  },
  {
    ...
    status: "available",
    heroImage: images["dog-dam-two"].src,
    heroAlt: "A chocolate Labrador puppy in an orange collar sitting on cut grass.",
    gallery: [],
    notes: null,
    litterId: "B-2025",
    sireName: "Birch",
